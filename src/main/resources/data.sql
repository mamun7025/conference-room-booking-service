...
INSERT INTO CONFERENCE_ROOM(NAME, CODE, CAPACITY, SLOT_INTERVAL, WORKING_HOUR_WINDOW, CREATED_BY, CREATED_DATE) VALUES ('Amaze', '501', 3, 15, '09:00-18:00', 'system', CURRENT_TIMESTAMP);
INSERT INTO CONFERENCE_ROOM(NAME, CODE, CAPACITY, SLOT_INTERVAL, WORKING_HOUR_WINDOW, CREATED_BY, CREATED_DATE) VALUES ('Beauty', '502', 7, 15, '09:00-18:00', 'system', CURRENT_TIMESTAMP);
INSERT INTO CONFERENCE_ROOM(NAME, CODE, CAPACITY, SLOT_INTERVAL, WORKING_HOUR_WINDOW, CREATED_BY, CREATED_DATE) VALUES ('Inspire', '503', 12, 15, '09:00-18:00', 'system', CURRENT_TIMESTAMP);
INSERT INTO CONFERENCE_ROOM(NAME, CODE, CAPACITY, SLOT_INTERVAL, WORKING_HOUR_WINDOW, CREATED_BY, CREATED_DATE) VALUES ('Strive', '504', 20, 15, '09:00-18:00', 'system', CURRENT_TIMESTAMP);

-- MAINTENANCE_SETTINGS >>> data populate
INSERT INTO MAINTENANCE_SETTINGS(CONFERENCE_ROOM_ID, MAINTENANCE_SLOT, CREATED_BY, CREATED_DATE) VALUES ((SELECT ID FROM CONFERENCE_ROOM WHERE NAME = 'Amaze'),'09:00-09:15', 'system', CURRENT_TIMESTAMP);
...
INSERT INTO MAINTENANCE_SETTINGS(CONFERENCE_ROOM_ID, MAINTENANCE_SLOT, CREATED_BY, CREATED_DATE) VALUES ((SELECT ID FROM CONFERENCE_ROOM WHERE NAME = 'Beauty'),'09:00-09:15', 'system', CURRENT_TIMESTAMP);
...
INSERT INTO MAINTENANCE_SETTINGS(CONFERENCE_ROOM_ID, MAINTENANCE_SLOT, CREATED_BY, CREATED_DATE) VALUES ((SELECT ID FROM CONFERENCE_ROOM WHERE NAME = 'Inspire'),'09:00-09:15', 'system', CURRENT_TIMESTAMP);
...
INSERT INTO MAINTENANCE_SETTINGS(CONFERENCE_ROOM_ID, MAINTENANCE_SLOT, CREATED_BY, CREATED_DATE) VALUES ((SELECT ID FROM CONFERENCE_ROOM WHERE NAME = 'Strive'),'09:00-09:15', 'system', CURRENT_TIMESTAMP);
