...
INSERT INTO MAINTENANCE_SETTINGS(CONFERENCE_ROOM_ID, MAINTENANCE_SLOT, CREATED_BY, CREATED_DATE) VALUES ((SELECT ID FROM CONFERENCE_ROOM WHERE NAME = 'Amaze'),'09:00-9:15', 'system', CURRENT_TIMESTAMP);
...
INSERT INTO MAINTENANCE_SETTINGS(CONFERENCE_ROOM_ID, MAINTENANCE_SLOT, CREATED_BY, CREATED_DATE) VALUES ((SELECT ID FROM CONFERENCE_ROOM WHERE NAME = 'Beauty'),'09:00-9:15', 'system', CURRENT_TIMESTAMP);
...
INSERT INTO MAINTENANCE_SETTINGS(CONFERENCE_ROOM_ID, MAINTENANCE_SLOT, CREATED_BY, CREATED_DATE) VALUES ((SELECT ID FROM CONFERENCE_ROOM WHERE NAME = 'Inspire'),'09:00-9:15', 'system', CURRENT_TIMESTAMP);
...
INSERT INTO MAINTENANCE_SETTINGS(CONFERENCE_ROOM_ID, MAINTENANCE_SLOT, CREATED_BY, CREATED_DATE) VALUES ((SELECT ID FROM CONFERENCE_ROOM WHERE NAME = 'Strive'),'09:00-9:15', 'system', CURRENT_TIMESTAMP);
